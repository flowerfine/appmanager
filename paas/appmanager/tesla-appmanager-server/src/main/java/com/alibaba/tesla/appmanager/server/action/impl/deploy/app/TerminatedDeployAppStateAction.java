...
/**
 * App 部署工单 State 处理 Action - TERMINATED
 *
 * @author yaoxing.gyx@alibaba-inc.com
 */
@Slf4j
@Service("TerminatedDeployAppStateAction")
public class TerminatedDeployAppStateAction implements DeployAppStateAction, ApplicationRunner {

    private static final DeployAppStateEnum STATE = DeployAppStateEnum.TERMINATED;
    ...
    public void run(ApplicationArguments args) throws Exception {
        timer = meterRegistry.timer("deploy.app.status.terminated.timer");
        counter = meterRegistry.counter("deploy.app.status.terminated.counter");
    ...
    public void run(DeployAppDO order, Map<String, String> attrMap) {
        ...
        counter.increment();
        log.info("deploy app has reached terminated state|deployAppId={}|appPackageId={}|cost={}",

...
/**
 * App 部署工单 State 处理 Action - SUCCESS
 *
 * @author yaoxing.gyx@alibaba-inc.com
 */
@Slf4j
@Service("SuccessDeployAppStateAction")
public class SuccessDeployAppStateAction implements DeployAppStateAction, ApplicationRunner {

    private static final DeployAppStateEnum STATE = DeployAppStateEnum.SUCCESS;
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        counter = meterRegistry.counter("deploy.app.status.success.counter");
